...
class PDF_HTML extends FPDF2File
{
...
function WriteHTML($h, $html)
{
    ...
    $html=str_replace("\n",' ',$html); //remplace retour àa ligne par un espace
    $a=preg_split('/<(.*)>/U',$html,-1,PREG_SPLIT_DELIM_CAPTURE); //éate la chaî avec les balises
...
function OpenTag($tag, $attr)
{
    ...
    switch($tag){
        ...
        case 'BLOCKQUOTE':
        case 'BR':
            $this->Ln($this->ln_height);
            break;
        case 'P':
            $this->Ln($this->ln_height * 2);
            break;
        case 'FONT':
...
function PutLink($URL, $txt)
{
    ...
    $this->Write($this->ln_height,$txt,$URL);
